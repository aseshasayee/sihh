...
export default function EcozyApp() {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link href="/signin">
              <Button className="bg-secondary text-secondary-foreground hover:bg-secondary/90">Sign In</Button>
            </Link>
          </div>
  ...
  const DashboardPage = () => (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        <h1 className="font-playfair text-3xl font-bold mb-2">Welcome back, {currentUser.name}! 🌱</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-primary">{currentUser.ecoPoints}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-secondary">{currentUser.streak} days 🔥</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-chart-4">#{currentUser.rank}</div>
            <p className="text-xs text-muted-foreground">in {currentUser.school}</p>
          </CardContent>
        </Card>
      </div>
          ...
          <div className="space-y-4">
            {dailyTasks.map((task) => (
              <div key={task.id} className="flex items-center justify-between p-3 rounded-lg border">
                ...
                <Badge variant={task.completed ? "secondary" : "outline"}>+{task.points} points</Badge>
              </div>
            ))}
          </div>
          <div className="mt-4">
        ...
        <CardContent>
          <div className="flex flex-wrap gap-4">
            {currentUser.badges.map((badge, index) => (
              <div key={index} className="flex flex-col items-center p-4 rounded-lg border bg-muted/50">
                <div className="text-3xl mb-2">{badge}</div>
                <span className="text-xs text-center text-muted-foreground">
                  {index === 0 && "Tree Planter"}
                  {index === 1 && "Water Saver"}
                  {index === 2 && "Recycling Hero"}
                  {index === 3 && "Eco Warrior"}
                </span>
              </div>
            ))}
